...
function StatesProvider({ children }) {
    ...
    const [apiCarregador] = useState(
        [
            {id: 346234875, valor: "299,00", modelo: "Original Apple Carregador 20W USB-C", img: "https://conceitoystore.com.br/cdn/shop/products/product-image-1820450131-removebg-preview.png?v=1635362399&width=1445"},
            {id: 78234657 , valor: "180,97", modelo: "Fonte Original Apple Carregador 20W USB-C", img: "https://microimport.com.br/wp-content/uploads/fonte-para-carregador-de-iphone-modelo-20w-Usb-C.webp"},
            {id: 9234566, valor: "90,00", modelo: "Carregador Intelbras", img: "https://backend.intelbras.com/sites/default/files/styles/image_optim/public/2021-02/eual_12_pb_front.png"},
            {id: 98456325, valor: "170,76", modelo: "Carregador Apple Original", img: "https://lh6.googleusercontent.com/proxy/Ch_jFn6EEU6Ht6h94bUgkIelrpYCQKnpVoKHxCxnsGUEHP0ievoat1T5kpgRUXt34tWBbNSY-spwIB18Dw3o"},
            // {id: , valor: "", modelo: "", img: ""},
            // {id: , valor: "", modelo: "", img: ""},
            // {id: , valor: "", modelo: "", img: ""},
    ...
    console.log(apiCarregador);


    return (
        <StateContext.Provider value={{ log, setLog, apiNovidade, apiParaVoce, itemCapinhaInfo, setItemCapinhaInfo, capinhas, compra, setCompra, apiCarregador }}>
            {children}
